...
<body>
	<div class="mid">
		...
		<div>
			<div
				style="width: 700px; margin: 50px auto; margin-top:8%;position:relative;top:10px;">
				<a href="/"><i class="bi bi-house-fill" style="color:black;"></a></i>&nbsp > 오시는길
			</div>
			<div id="map" style="width: 700px; height: 350px; margin: 0px auto;">
			</div>
		</div>
